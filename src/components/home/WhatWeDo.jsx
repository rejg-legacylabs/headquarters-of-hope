...
import { Target, Home, GraduationCap, Shield, Compass, HeartHandshake } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    text: "Addressing transportation, documentation, legal, and systemic barriers that stand between people and opportunity.",
  },
  {
    icon: Compass,
